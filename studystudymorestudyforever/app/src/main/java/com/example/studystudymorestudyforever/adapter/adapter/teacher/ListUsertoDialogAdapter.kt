...
class ListUsertoDialogAdapter(context: Context, teacher:ArrayList<TeacherofStudent> , addFr:ICallAddFriend): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if(teacher!![position].getSTATUS() == 0)
        {
            ...
            if(teacher!![position].getSTATUS() == 3 ||teacher!![position].getSTATUS()==1 ||teacher!![position].getSTATUS()==2 )
            {
