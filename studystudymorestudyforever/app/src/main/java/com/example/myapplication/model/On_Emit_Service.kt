 ...
 */
class  On_Emit_Service private  constructor()
{
    //singleton
    companion object {
        private var instance : On_Emit_Service? = null
        fun getIns(): On_Emit_Service {
            if (instance == null) {
                Log.d("Call_Receive_Server", "getIns")
                instance = On_Emit_Service()
            }
            return instance!!
        }
    }
            ...
            object : Emitter.Listener {
                override fun call(vararg args: Any) {
                    ...
                    thread{
                        ...
                        On_Emit_Service.getIns()!!.Sevecie()
                    }
                }
            }
    ...
    fun writeSV(clientSeq:Int,workerName:String,serviceName:String,input:Array<String>):Emit_Service
    {
        var x: Emit_Service = Emit_Service()
    ...
    //doc file Json
    fun readJson(json: JSONObject): On_Service
    {
    ...
    fun writeJsonStream(output1: Writer, json: Emit_Service)
    {
